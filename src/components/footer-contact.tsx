...
export default function FormFooterContact() {
    return <form className="w-full mt-1" id="footer-contact-form" method="POST" action="" >
        ...
        <button type="submit" className="flex items-center text-white bg-green-700 hover:bg-green-800 focus:ring-2 focus:outline-none focus:ring-green-900 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center" data-callback='onSubmit' data-action='submit'>Submit&nbsp;<SendIcon className="text-base flex items-center"/> </button>
    </form >;
}

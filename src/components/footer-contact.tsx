    ...
    return (
        <form className="w-full mt-1 footer-contact-form" method="POST" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="relative z-0 w-full mb-3 group">
                <input {...register("name")} id="name" type="text" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b border-gray-600 appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " required disabled={loadingState} />
            ...
            <div className="relative z-0 w-full mb-3 group">
                <input {...register("email")} id="email" type="email" className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b border-gray-600 appearance-none focus:outline-none focus:ring-0 peer" placeholder=" " required disabled={loadingState} />
            ...
            <div className="relative z-0 w-full mb-3 group">
                <TextareaAutosize {...register("message")} id="message" className="footer-textarea block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b border-gray-600 appearance-none focus:outline-none focus:ring-0 peer" minRows={1} maxRows={4} placeholder=" " required disabled={loadingState} />

                            ...
                            <div className="front flex flex-col w-full h-full items-center">
                                ...
                                <div className="flex flex-col justify-between w-full h-full pb-6 px-3 md:px-8 pt-20 bg-gray-800 shadow-xl shadow-gray-900/70 rounded-lg">
                                    ...
                                    <div className="flex w-full justify-center">
                                        <Button className="button flex items-center bg-blue-800 hover:bg-blue-900 drop-shadow-xl rounded-2xl text-center text-md font-semibold px-3 py-1.5 mx-0 my-2 md:m-2" onClick={() => updateFlippedCards(education.school)}>
                                            View Courses
                                        </Button>
                                    </div>
                                </div>

    ...
    return (
        <div className="developer-accordion px-3 sm:px-0 mx-auto w-full md:w-1/2 space-y-4">
            {items.map((item: DevItems, index: number) => (
                index === activeIndex ? <>
                    <div key={item.title + activeIndex} className="min-w-full bg-gray-700 border-2 border-green-500 rounded-lg">
                    ...
                    <div key={item.title + activeIndex} className="min-w-full bg-gray-500 hover:bg-gray-600 border-2 rounded-lg">
